...
const runner = {
  ...
  setCommonOptions(options) {
    ...
    const defaultBabelrcPath = path.join(espackDirectory, '.babelrc');
    let babelrc;
  ...
  setCustomConfig(mergeJS) {
    ...
    // devServer hmr 不能使用 chunkhash
    if (this.dev) outputFileSettings.js = outputFileSettings.js.replace('chunkhash', 'hash');
